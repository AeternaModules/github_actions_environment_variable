output "actions_environment_variables_id" {
  ...
  value       = { for k, v in github_actions_environment_variable.actions_environment_variables : k => v.id if v.id != null && length(v.id) > 0 }
}
output "actions_environment_variables_created_at" {
  ...
  value       = { for k, v in github_actions_environment_variable.actions_environment_variables : k => v.created_at if v.created_at != null && length(v.created_at) > 0 }
}
output "actions_environment_variables_environment" {
  ...
  value       = { for k, v in github_actions_environment_variable.actions_environment_variables : k => v.environment if v.environment != null && length(v.environment) > 0 }
}
output "actions_environment_variables_repository" {
  ...
  value       = { for k, v in github_actions_environment_variable.actions_environment_variables : k => v.repository if v.repository != null && length(v.repository) > 0 }
}
output "actions_environment_variables_repository_id" {
  ...
  value       = { for k, v in github_actions_environment_variable.actions_environment_variables : k => v.repository_id if v.repository_id != null }
}
output "actions_environment_variables_updated_at" {
  ...
  value       = { for k, v in github_actions_environment_variable.actions_environment_variables : k => v.updated_at if v.updated_at != null && length(v.updated_at) > 0 }
}
output "actions_environment_variables_value" {
  ...
  value       = { for k, v in github_actions_environment_variable.actions_environment_variables : k => v.value if v.value != null && length(v.value) > 0 }
}
output "actions_environment_variables_variable_name" {
  ...
  value       = { for k, v in github_actions_environment_variable.actions_environment_variables : k => v.variable_name if v.variable_name != null && length(v.variable_name) > 0 }
}
